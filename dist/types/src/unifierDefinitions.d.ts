import { IExtensionSettings, ProofMode } from '../yamma/server/src/mm/ConfigurationManager';
...
export type CreateUnifier = (mmData: string | MmParser, config?: UnifierConfig) => Unifier;
export type ParseMm = (mmData: string, config?: UnifierConfig) => MmParser;
export type ParseMmp = (mmpData: string, mmParser: MmParser, config?: UnifierConfig) => MmpParser;
export {};
